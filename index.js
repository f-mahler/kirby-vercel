...
},{}],"../node_modules/dayjs/plugin/relativeTime.js":[function(require,module,exports) {
var define;
...
},{}],"components/Vercel.vue":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  methods: {
    checkSiteModified: function checkSiteModified() {
    ...
    deploySite: function deploySite() {
      var _this = this;
      ...
      this.latest = null;
      this.isLoading = true;
      this.$api.get("vercel").then(function (response) {
    ...
    getLatest: function getLatest() {
      ...
      this.$api.get("vercel/latest").then(function (response) {
        var res = JSON.parse(response);
        _this2.latest = res.deployments[0];

        _this2.checkSiteModified();
      }).catch(function (e) {
        console.log(e);
      });
    }
  ...
  filters: {
    date: function date(value) {
      ...
      _dayjs.default.extend(relativeTime);

      return (0, _dayjs.default)(value).locale('fr').fromNow();
    }
  }
};
exports.default = _default;
        var $d692f9 = exports.default || module.exports;
      
      if (typeof $d692f9 === 'function') {
        $d692f9 = $d692f9.options;
      }
    
        /* template */
        Object.assign($d692f9, (function () {
          var render = function() {
  var _vm = this
  ...
  return _c("div", { staticClass: "k-vercel" }, [
    _c(
      "div",
      { staticClass: "k-vercel-label" },
      [
        _c("k-headline", [_vm._v(_vm._s(_vm.label))]),
        _vm._v(" "),
        _vm.latest
          ? _c("div", { staticClass: "k-vercel-latest" }, [
              _c("span", { attrs: { "data-status": _vm.latest.state } }),
              _vm._v(_vm._s(_vm._f("date")(_vm.latest.created)) + "\n    ")
            ])
          : _vm._e()
      ],
      1
    ...
    _vm.button
      ? _c(
          "div",
          {
            staticClass: "k-vercel-button",
            class: {
              loading: _vm.isLoading,
              success: _vm.isSuccess,
              error: _vm.isError
            },
            on: { click: _vm.deploySite }
          },
          [
            _vm.isLoading
            ...
            _vm.latest && !_vm.isLoading && !_vm.isSuccess && !_vm.isError
              ? _c(
                  "div",
                  {
                    staticClass: "k-vercel-changes",
                    class: { new: _vm.newContent }
                  },
                  [
                    _vm.newContent
                      ? _c("span", [
                          _vm._v(_vm._s(_vm.siteModified.count) + " ↑")
                        ])
    ...
    _vm.help
      ? _c("div", {
          staticClass: "k-vercel-help k-text k-field-help",
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$d692f9', $d692f9);
          } else {
            api.reload('$d692f9', $d692f9);
          }
        }
...
},{"dayjs":"../node_modules/dayjs/dayjs.min.js","dayjs/plugin/relativeTime":"../node_modules/dayjs/plugin/relativeTime.js","_css_loader":"../../../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"../node_modules/vue-hot-reload-api/dist/index.js","vue":"../node_modules/vue/dist/vue.runtime.esm.js"}],"index.js":[function(require,module,exports) {
"use strict";

var _Vercel = _interopRequireDefault(require("./components/Vercel.vue"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

panel.plugin("f-mahler/kirby-vercel", {
  fields: {
    vercel: _Vercel.default
  }
});
},{"./components/Vercel.vue":"components/Vercel.vue"}],"../../../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
